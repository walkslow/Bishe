...
# 将室温下的能道数据df1和加热后的能道数据df2添加到session_state中，df1和df2均为包含channels和counts这2列的dataframe
...
# 根据输入的channel，查询counts_origin和counts_after
with container3:
